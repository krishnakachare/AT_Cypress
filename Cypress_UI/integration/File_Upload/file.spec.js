describe('verify the file_upload',()=>{

    it('file upload testcase one',()=>{
    ...
    it('file ',()=>{
        ...
        cy.on('window:alert',(a)=>{
            expect(a).to.contains('You need to select a file to upload!');
         })

    })

    it.only('upoloading multiple files', () => {
        cy.visit('https://www.igniteui.com/file-upload/multiple-upload')
        const fixturePath = 'abc.png'
        const fixturePath2 = 'abc.png'
        let arr = [fixturePath,fixturePath2]
...
// get this plugin from 'https://www.npmjs.com/package/cypress-file-upload' from this url get and store (import 'cypress-file-upload';) this plugin in command.js file
